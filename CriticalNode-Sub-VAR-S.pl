...
#
# Output to VARS file for summer months ( including June, July, Aug, Sept)
#
...
#	}	
	...
	$tdev=$dev;
	print VARS "$col,$dev,$nextdev,";
	printf VARS "%.0f,%.0f,%.0f,%.0f,%.0f,%.1f",$hmean,$cmean,$rmean,$cnt,$totcnt,$avepath;
	print VARS "\n";		
}
close VARS;
#print T5 "$col,$tdev,";
